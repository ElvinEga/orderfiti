                    ...
                    <Carousel :settings="settings" :breakpoints="breakpoints">
                        <Slide class="swiper-slide" v-for="(category, index) in categories" :key="category"
                            ...
                            <router-link v-if="index === 0" to="" @click.prevent="allCategory(category)"
                                class="swiper-slide w-32 flex flex-col items-center text-center gap-4 p-3 rounded-2xl border-b-2 border-transparent transition hover:bg-primary-light bg-[#F7F7FC] overflow-hidden">
